...
from navtelemator.api import customer_circuits
...
urlpatterns = patterns('',
                       ...
                       url(r'^api/1.0/customer_circuits/(?P<customerid>.+)', customer_circuits.render_customer_circuits, name='customer-capacity'),
